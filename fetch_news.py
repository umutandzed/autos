...
# Ücretsiz Gemini limiti: dakikada 15 istek
# 5 saniye bekleme = dakikada max 12 istek → güvenli
...
RSS_FEEDS = [
    ...
    {
        "brand": "Engineering.com",
        "url": "https://www.engineering.com/rss",
        "category_default": "Industrial AI"
    },
    {
        "brand": "Machine Design",
        "url": "https://www.machinedesign.com/rss/all",
...
def fetch_feed(url):
    try:
        ...
        if data.get("status") == "ok":
            ...
            return items[:2]  # Her kaynaktan 2 haber, toplam 10
        else:
...
{{
  ...
  "readTime": "X dk"
    ...
    try:
        # Rate limiting - ücretsiz quota aşımını önle
